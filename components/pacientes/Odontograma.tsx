    ...
    return (
        <div className="space-y-4">
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-slate-50">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            onClick={resetAll}
                            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-slate-500 bg-white border border-slate-200 rounded-lg hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-all"
                        >
                ...
                {/* Tooltip flotante */}
                {tooltip && (
                    <div className="text-center py-1 bg-[#051650] text-white text-xs font-bold">
                        {tooltip}
                    </div>
                )}
            ...
            <div className="bg-[#051650] rounded-xl p-5 border border-white/10 shadow-lg">
                ...
                <button className="mt-3 w-full py-2 bg-white text-[#051650] rounded-lg text-xs font-black uppercase tracking-widest hover:bg-blue-50 transition-all active:scale-95">
