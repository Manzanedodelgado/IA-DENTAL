                                ...
                                <div className="text-left">
                                    {isEditing ? (
                                        <div className="flex flex-col gap-1.5" onClick={e => e.stopPropagation()}>
                                            <input
                                                autoFocus
                                                className="text-[11px] font-black uppercase tracking-tighter leading-none bg-slate-50 border border-slate-200 text-slate-800 px-2 py-1 rounded outline-none w-32 focus:ring-1 focus:ring-secondary"
                                                value={editForm.nombre}
                                                onChange={e => setEditForm({ ...editForm, nombre: e.target.value })}
                                            />
                                            <input
                                                className="text-[9px] font-bold mt-0.5 bg-slate-50 border border-slate-200 text-slate-600 px-2 py-1 rounded outline-none w-32 focus:ring-1 focus:ring-secondary"
