        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
            ...
            <div className="space-y-4">
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 space-y-4">
                    <p className="text-[12px] font-black text-[#051650] uppercase tracking-widest">Nueva Automatización / Flujo</p>
                    <div>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 space-y-3">
                    <p className="text-[12px] font-black text-[#051650] uppercase tracking-widest">Pasos del flujo</p>
                    {steps.map((step, i) => (
                        <div key={i} className="flex flex-col gap-1.5">
                            <div className="flex items-center gap-2">
                                <span className="text-[9px] font-black text-slate-400 uppercase bg-slate-50 border border-slate-200 px-2 py-1 rounded-lg">{step.label}</span>
                    ...
                    <div className="pt-2 border-t border-slate-100">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {STEP_TYPES.map(s => (
                                <button key={s.key} onClick={() => addStep(s.key as StepType['type'])} className="flex items-center gap-1 px-2.5 py-1.5 text-[10px] font-bold bg-slate-50 border border-slate-200 rounded-lg hover:border-[#0056b3]/30 hover:text-[#0056b3] transition-all">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
                <p className="text-[12px] font-black text-[#051650] uppercase tracking-widest mb-4">Vista previa del flujo</p>
                {!name && !trigger ? (
